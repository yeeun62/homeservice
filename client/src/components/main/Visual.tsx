...
function Visual({ data, visualTitle, visualSpan, bottom }: any) {
    ...
    const { makerNm, modelDetailNm, gradeNm, gradeDetailNm } = data.simpleCar.trim;
        ...
        <VisualWrap bottom={bottom}>
            ...
            <div className="info_wrap">
                ...
                <div className="info_wrap_right">
                    ...
                    <RegistTitle className="name">{`${makerNm ? makerNm : ""} ${modelDetailNm ? modelDetailNm : ""} ${
                        gradeNm ? gradeNm : ""
                    } ${gradeDetailNm ? gradeDetailNm : ""}`}</RegistTitle>
                    <p className="price">
